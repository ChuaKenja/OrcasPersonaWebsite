...
const REVEAL_CONTENT = [
  ...
  {
    upper: profile.learning.slice(0, 3),
    lower: profile.quickFacts.find(fact => fact.label === "Currently")?.value || "Current focus areas in learning journey",
  },
];
...
const ITEMS = [
  {
    ...
    stats: [
      ...
      { tag: "Focus", value: profile.quickFacts.find(fact => fact.label === "Currently")?.value.split(',')[0] || "Learning", color: "#e8c100" },
    ],
  },
  {
  ...
  },
  {
    ...
    stats: [
      { tag: "AREAS", value: profile.learning.length.toString(), color: "#ff6b6b" },
